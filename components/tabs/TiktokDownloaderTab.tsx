  ...
  return (
    <div className="bg-slate-800/50 rounded-xl border border-slate-700 shadow-xl p-6 max-w-4xl mx-auto animate-fade-in">
       <div className="space-y-6">
          ...
          <p className="text-slate-400">Cole um link de vídeo do TikTok abaixo para baixá-lo sem marca d'água. O vídeo será carregado no app para ser usado nas outras abas.</p>
